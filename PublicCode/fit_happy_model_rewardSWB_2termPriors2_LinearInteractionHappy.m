function result_best = fit_happy_model_rewardSWB_2termPriors2_LinearInteractionHappy(term1_mtx,happyscore,priors,constant,type)
...
[happypred] = happy_model_2term_linearInteractionHappy(a,b,tau1,const, result.term1_mtx);
