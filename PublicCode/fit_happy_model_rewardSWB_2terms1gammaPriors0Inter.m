function result_best = fit_happy_model_rewardSWB_2terms1gammaPriors0Inter(term1_mtx,term2_mtx,happyscore,priors,constant,type)
...
[happypred] = happy_model_2terms_inter(a,b,tau1,tau2,const,result.term1_mtx,result.term2_mtx);
